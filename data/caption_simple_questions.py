...
def create_star_prompt(example):
    ...
    base_prompt = """
You are an expert astrophysicist specializing in stellar evolution.
Create a general question like 'describe this star' or 'what is interesting about this star'. The question should be simple and general.
then, describe this star in detail. Act like a scientist. Do not converse please, just give your description in a scientific tone.
...
Based on this information, create a unique description about this star's evolution that includes:
- short question about the stellar parameters of the star. This can be in the form of concrete question, or asking to describe the star.
- short answer that includes the stellar parameters of the star (Teff, logg, FeH).
- the format should be a json format with 'question' and 'description' fields.

Return only the raw JSON object in exactly this structure:

{{
"Question": "Your simple question about the star...",
"Description": "Your description of the star..."
}}

IMPORTANT: Keep your response concise and under 50 words total.
"""
...
if __name__ == "__main__":
    ...
    generate_stellar_descriptions(df,
     output_file='/data/TalkingLatents/data/dataset/stellar_descriptions_questions_short.json',
     n_processes=16)
